                    ...
                    <li className="team-item">
                        <div className="profile">
                            ...
                            <div className="profile-contents">
                                ...
                                <p className="myself2">"Could you give me a vacation ?"</p>
                            </div>
                        </div>
                    </li>
                    ...
                    <li className="team-item">
                        <div className="profile">
                            ...
                            <div className="profile-contents">
                                ...
                                <p className="myself4">I'm so sad</p>
                            </div>
                        </div>
                    </li>
                    ...
                    <li className="team-item">
                        <div className="profile">
                            ...
                            <div className="profile-contents">
                                ...
                                <p className="myself5">"Want to be a designer who gives people a chance to choose better things"</p></div>
                        </div>
                    </li>
                </div>
            </div>
